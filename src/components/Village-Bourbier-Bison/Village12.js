...
function Village12(component) {
    const nextComponentRandomBattle05 = () => {
        // On change le Props Ici pour passer au composant suivant
        component.setComponent("randomBattle05")
    }
    ...
    return (
        <div className="adventure__Container">
            <p className="fade-in textAlign">
                ...
                Vous vous figez sur place, horrifié, et vous entendez les bandits se rapprocher.
            ...
            <div className='adventure__ChooseButton__Container'>
                <button className='battle__ChooseButton' onClick={nextComponentRandomBattle05}>
                    Affronter le bandit
