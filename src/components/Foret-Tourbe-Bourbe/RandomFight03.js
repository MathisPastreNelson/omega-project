...
import imageEnemy from '../../assets/enemyImg/WereWolf.webp'
...
function RandomFight03(component) {
    ...
    let goldEarned = Math.floor(Math.random() * 3) + 20;
    let xpEarned = Math.floor(Math.random() * 2) + 20;
